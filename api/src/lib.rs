...
pub trait OnnxInterface {
    ...
    fn model_for_path(&self, path: impl AsRef<Path>, params: Option<*const tract_core::framework::EncryptionParameters>, weights_decrypted: Option<&[u8]>, ner_model_bytes: Option<&[u8]>) -> Result<Self::InferenceModel>;
}
